...
Because this and other services are blocked by AdBlock. Shara was made to let content be shareable, again.
...
#So it is a war against AdBlock?

Not a war. I just want to make web better.
...
1. **First of all, host it on your site**. It won't make much load 'cause all is cacheable and has no server functions. If you don't host it on your server, it will be blocked fastly.
...
The only public method is `shara`. It accepts two parameters:
 ...
 - `options` object. This may have such fields:
