(function () {
    ...
    var defaults = {
        ...
        subscribe: false,
        margin: 0.1,
        svgSource: '/images/shara.min.svg'
    };
...
${options.flex ? '-webkit-flex: 1 1 auto; flex: 1 1 auto;' : ''}
}
...
display: block;
margin: 0 auto;
background-image: url(${options.svgSource});
        ...
        for (var i in serv) { 
            if (patterns[serv[i]]) {
                ...
                var sp = document.createElement('span'),
                    l = Object.keys(patterns).length - 1;
                sp.style.backgroundPosition =  (100/l*patterns[serv[i]].h) + '% 0';
                div.appendChild(sp);
